...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    CANSparkMax leftMotor = setupCANSparkMax(20, Sides.LEFT, false);

    CANSparkMax leftFollowerID21 = setupCANSparkMax(21, Sides.FOLLOWER, false);
    leftFollowerID21.follow(leftMotor, false);
        
    

    CANSparkMax rightMotor = setupCANSparkMax(22, Sides.RIGHT, false);
    CANSparkMax rightFollowerID23 = setupCANSparkMax(23, Sides.FOLLOWER, false);
    rightFollowerID23.follow(rightMotor, false);
