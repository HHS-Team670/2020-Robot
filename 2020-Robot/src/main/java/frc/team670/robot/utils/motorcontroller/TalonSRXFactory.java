...
/**
 * Utility class for configuring a TalonSRX to default settings and resetting to factory defaults.
...
public class TalonSRXFactory{
    ...
    //TODO: figure out some values for this config, because I dropped something random...might want to change these?
    static{
    ...
    /**
     * Create a TalonSRX with factory settings, as well as configuring other settings to a usable default.
     */
     ...
     * @return TalonSRX set to follow the 'master', with appropriate follower settings as well
     */
    ...
    public static TalonSRX buildTalonSRX(int deviceID, Config config){
        ...
        talonsrx.setStatusFramePeriod(StatusFrameEnhanced.Status_1_General,
