...
public class FieldConstants {
      ...
      public static final double FAR_TARGET_Y_POS = Units.feetToMeters(27 / 2) - Units.inchesToMeters(43.75)
                  - Units.inchesToMeters(48.0 / 2.0);
      public static final Pose2d FAR_TARGET_POSE = new Pose2d(new Translation2d(FAR_TARGET_X_POS, FAR_TARGET_Y_POS),
                  new Rotation2d(0.0));
