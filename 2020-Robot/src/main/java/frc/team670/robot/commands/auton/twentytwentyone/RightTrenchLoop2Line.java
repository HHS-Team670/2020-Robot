 ...
 * @author tarini
 */
public class RightTrenchLoop2Line extends SequentialCommandGroup implements MustangCommand {

    private Map<MustangSubsystemBase, HealthState> healthReqs;
    private DriveBase driveBase;
    private Path trajectory1, trajectory2;
    
    public RightTrenchLoop2Line(DriveBase driveBase, Intake intake, Conveyor conveyor, 
